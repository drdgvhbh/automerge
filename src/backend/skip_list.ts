...
class Node {
  ...
  public insertBefore(newKey, newLevel, fromLevel, distance) {
  ...
  public removeAfter(fromLevel, removedLevel, newKeys, distances) {
    const nextKey = this.nextKey.slice();
    const nextCount = this.nextCount.slice();
  ...
  public removeBefore(fromLevel, removedLevel, newKeys, distances) {
    const prevKey = this.prevKey.slice();
    const prevCount = this.prevCount.slice();
...
class SkipList {
  ...
  constructor(randomSource?) {
    ...
    return makeInstance(0, Map().set(null as any, head), random);
  }
  ...
  public predecessors(predecessor, maxLevel) {
    const preKeys = [predecessor];
    const preCounts = [1];
  ...
  public successors(successor, maxLevel) {
  ...
  public insertAfter(predecessor, key, value) {
  ...
  public insertIndex(index, key, value) {
